...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand ml-5 mr-5" href="#"><span class="lo"><span class="ech">Echo</span>SHOP</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarcollapse">
                <ul class="navbar-nav ml-auto mr-3">
                    ...
                    <li class="nav-item mr-3">
                        <a href="#header" class="nav-link">Products</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- end of navbar -->
    <!-- background image -->
    <div class="bg-image" style="background-image: url('images/bg5.jpeg');background-repeat:no-repeat;background-size:cover; height:100vh;">
        <div class="container ml-auto mr-auto pl-1 pt-4">
            <div  id="content">
                <h3>everything yo<span style="color: #ff8409;">u need is here</span></h3>
                <p>Laptops, Smartphones, Tablets, Gaming PCs... and more of other electronic devices.</p>
                <a href="#header" id="btn">SHOP NOW</a>
            </div>
        </div>
    </div>
    <!-- end of background image -->
    <!-- header -->
    <header id="header" class="col-md-11 ml-auto mr-auto   py-3 mt-3 mb-4">
        <div class="container">
            <div class="row">
                <div class="col-md-12" id="headdiv">
                    <h2 class="mb-3">Cate<span  style="color: #ff8409;">gories</span></h2>
                    <!-- Button trigger modal1 --> 
                    <button type="button" class="btn mb-2 mr-2" data-toggle="modal" data-target="#exampleModalScrollable">Laptops </button> 
                    <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true"> 
                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> 
                            <div class="modal-content"> 
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalScrollableTitle">Category : Laptops</h5> 
                                ...
                                <div class="modal-body pr-4 pl-4">
                                    <div id="pop" class="row">
                                        <?php
                                        $sql="SELECT * FROM items WHERE category='laptops'";
                                        $stmt=$dbconn->query($sql);
                                        while ($rows=$stmt->fetch()) {
                                            $id = $rows['item_id'];
                                            $image = $rows['image'];
                                            $productname = $rows['title'];
                                            $category = $rows['category'];
                                            $price = $rows['price'];
                                            $description = $rows['description']; ?>
                                        <div id="pop" class="col-md-4 mb-3 ml-auto mr-auto">
                                            <div class="card bg-dark text-light">
                                                <img id="imgpop" src="admin/uploads/<?php echo $image; ?>" class="img pb-2" alt="">
                    ...
                    <button type="button" class="btn mb-2 mr-2" data-toggle="modal" data-target="#exampleModalScrollable1">Smartphones </button> 
                    <div class="modal fade" id="exampleModalScrollable1" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true"> 
                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> 
                            <div class="modal-content"> 
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalScrollableTitle">Category : Smartphones</h5> 
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
                                        <span aria-hidden="true"></span> 
                                    </button> 
                                </div> 
                                <div class="modal-body pr-4 pl-4">
                                    <div id="pop" class="row">
                                        <?php
                                        $sql="SELECT * FROM items WHERE category='smartphones'";
                                        $stmt=$dbconn->query($sql);
                                        while ($rows=$stmt->fetch()) {
                                            $id = $rows['item_id'];
                                            $image = $rows['image'];
                    ...
                    <button type="button" class="btn mb-2 mr-2" data-toggle="modal" data-target="#exampleModalScrollable2">Tablets </button> 
                    <div class="modal fade" id="exampleModalScrollable2" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true"> 
                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> 
                            <div class="modal-content"> 
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalScrollableTitle">Category : Tablets</h5> 
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
                                        <span aria-hidden="true"></span> 
                                    </button> 
                                </div> 
                                <div class="modal-body pr-4 pl-4">
                                    <div id="pop" class="row">
                                        <?php
                                        $sql="SELECT * FROM items WHERE category='tablets'";
                                        $stmt=$dbconn->query($sql);
                                        while ($rows=$stmt->fetch()) {
                                            $id = $rows['item_id'];
                                            $image = $rows['image'];
                    ...
                    <button type="button" class="btn mb-2 mr-2" data-toggle="modal" data-target="#exampleModalScrollable3">PC Gamer </button> 
                    <div class="modal fade" id="exampleModalScrollable3" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true"> 
                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> 
                            <div class="modal-content"> 
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalScrollableTitle">Category : PC Gamer</h5> 
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
                                        <span aria-hidden="true"></span> 
                                    </button> 
                                </div> 
                                <div class="modal-body pr-4 pl-4">
                                    <div id="pop" class="row">
                                        <?php
                                        $sql="SELECT * FROM items WHERE category='pc gamer'";
                                        $stmt=$dbconn->query($sql);
                                        while ($rows=$stmt->fetch()) {
                                            $id = $rows['item_id'];
                                            $image = $rows['image'];
                    ...
                    <button type="button" class="btn mb-2 mr-2" data-toggle="modal" data-target="#exampleModalScrollable4">Others </button> 
                    <div class="modal fade" id="exampleModalScrollable4" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true"> 
                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document"> 
                            <div class="modal-content"> 
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalScrollableTitle">Category : Others</h5> 
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
                                        <span aria-hidden="true"></span> 
                                    </button> 
                                </div> 
    ...
    <div class="container mb-4">
        <form action="index.php#header">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Search for Something..." name="search" value="">
                <div class="input-group-apend">
                    <button class="btn btn-secondary form-control"  name="searchbtn">
    ...
    <section class="collection col-md-11 ml-auto mr-auto mt-3 mb-5">
        <div class="container-fluid">
            <h1 class="text-center">New Pr<span  style="color: #ff8409;">oducts</span></h1>
            <div class="row py-3">
                <?php
                ...
                <div class="mr-auto ml-auto  mt-4">
                    <div class="card bg-dark mb-3 text-light">
                        <img src="admin/uploads/<?php echo $image; ?>" class="img pb-2" alt="">
                        <form method="POST" action="index.php?id=<?php echo $id?>#added">
                        <input type="submit" value="Add To Cart" name="addcart"><a name="added">
                            <!-- <input type="submit" value="Add To Cart" name="addcart"> -->
                            <input type="hidden" value="<?php echo $id?>" name="idp">
                        </form>
                        <h5><?php echo $productname; ?></h5>
                        <span id="price"><?php echo $price; ?> HD</span>
                    </div>
                </div>
                <?php
                }?>
