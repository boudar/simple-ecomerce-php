...
<body id="bdy">
    ...
    <!-- end of navbar -->
    <!-- Main  -->
    <section class="collection col-md-11 ml-auto mr-auto mt-3 mb-5  bg-dark text-light" id="abcontent">
        <div class="container-fluid">
            <h1 class="text-center">Abo<span  style="color: #ff8409;"ut >ut Us</span></h1>
            <div class="row pb-4">
                <div id="img45" class="col-md-6">
                <span class="lo"><span class="ech">Echo</span>SHOP</span>
                    <h3 class="mt-5 ml-3">Tech Store</h3>
                    <p class="ml-3">One of the most recomanded e-commerce web-sites</p>
                    <p class="ml-3">We created this web site to fullfill the increasing need of people whom search for a sincer and safe ecommerce web site where they can find anything they're looking for.</p>
                </div>
                <div class="col-md-6">
                    <p><b class="ml-4">Lorem ipsum placeat at recusandae unde mollitia? Aspernatur, voluptates odio? Quo qui provident accusantium atque in necessitatibus, quisquam modi optio.</b> Aspernatur, voluptates odio? Quo qui provident accusantium atque in necessitatibus, quisquam modi optio.</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum optio ratione ipsum placeat at recusandae unde mollitia? Aspernatur, voluptates odio? Quo qui provident accusantium atque in necessitatibus, quisquam modi optio.</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum optio ratione ipsum placeat at recusandae unde mollitia? Aspernatur, voluptates odio? Quo qui provident accusantium atque in necessitatibus, quisquam modi optio.</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum optio ratione ipsum placeat at recusandae unde mollitia? Aspernatur, voluptates odio? Quo qui provident accusantium atque in necessitatibus, quisquam modi optio.</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum optio ratione ipsum placeat at recusandae unde mollitia? Aspernatur, voluptates odio? Quo qui provident accusantium atque in necessitatibus, quisquam modi optio.</p>
                </div>
    ...
    <section class="collection col-md-11 ml-auto mr-auto mt-3 mb-5  bg-dark text-light" id="abcontent">
        <div class="container-fluid pb-4  pr-auto pl-auto">
            <h1 class="text-center">CREAT<span style="color: #ff8409;">ED BY</span></h1>
            <div class="row py-3">
                <div class="col-md-3 mr-5 mb-5 ml-auto mr-auto">
                    <div id="card" class="card ml-auto mr-auto">
                        <img id="pimg" src="images/20191118_223001.png" class="img-fluid mb-3" alt="">
                        <h5 style="color: black;">YASSINE BAHMANE</h5>
                        <span>WEB DEVELOPPER</span>
                        <div id="social" class="row ml-auto mr-auto mb-3 mt-2">
                            <a class="mr-4" href="#"><svg width="30" height="30" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                            </svg></a>
                            <a class="mr-4" href="#"><svg width="30" height="30" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                            ...
                            <a class="mr-4" href="#"><svg width="30" height="30" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                ...
                <div class="col-md-3 ml-auto mr-auto">
                    <div id="card" class="card ml-auto mr-auto mb-3">
                        <img id="pimg" src="images/20191019_163037.jpg" class="img-fluid mb-3" alt="">
                        <h5 style="color: black;">ABDELLAH BOUDAR</h5>
                        <span>WEB DEVELOPPER</span>
                        <div id="social" class="row ml-auto mr-auto mb-3 mt-2">
                            <a class="mr-4" href="#"><svg width="30" height="30" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
    ...
    <footer class="bg-dark text-light pt-3 pb-4">
            <div class="container">
                ...
                <div id="footsocial" class="col-md-10 row mb-3 mt-1 ml-auto mr-auto">
