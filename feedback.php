...
<body>
    ...
    <h1 class="text-center"> Custmer's <span style="color: #ff8409;">Review</span> </h1>
    <section class="container col-md-12" id="review">
        <div class="row  ml-auto mr-auto pr-5 pl-5">

            <div id="box" class="col-md-3  ml-auto mr-auto mb-3 pb-3">
                <svg xmlns= width="70" height="70" fill="currentColor" class="bi bi-quote" viewBox="0 0 16 16">
                <path d="M12 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1h-1.388c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0 0 0-1.085.992 4.92 4.92 0 0 0-.62 1.458A7.712 7.712 0 0 0 9 7.558V11a1 1 0 0 0 1 1h2Zm-6 0a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1H4.612c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0 0 0-1.085.992 4.92 4.92 0 0 0-.62 1.458A7.712 7.712 0 0 0 3 7.558V11a1 1 0 0 0 1 1h2Z"/>
                </svg>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi nulla sit libero nemo fuga sequi nobis?.</p>
                <img src="images/20191019_163037.jpg" alt="" id="user">
                <h3>john deo</h3>
                <div class="stars">
                    <svg width="20" height="20" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
            ...
            <div id="box" class="col-md-3  ml-auto mr-auto mb-3 pb-3">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi nulla sit libero nemo fuga sequi nobis?.</p>
                <img src="images/20191118_223001.png" alt="" id="user">
                <h3>john deo</h3>
                <div class="stars">
                    <svg width="20" height="20" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
                    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
    ...
    <form action="feedback.php" method="post">  
        ...
        <input type="email" name="email" class="form-control" id="exampleFormControlInput1" placeholder="Enter Your Email Adresse">
        </div>
        </div>
        <div class="mb-7">
        <label for="exampleFormControlTextarea1" class="form-label">Feedback</label>
        <textarea name="feedback" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        <input type="submit" name="sendfeed" value="Send Feedback" class="btn btn-success mt-4">
        </form>
        <?php
        require "conn.php";
        if (isset($_POST['sendfeed'])) {
            ...
            $fd = $con->prepare("INSERT INTO feedbacks(email,username,feed) VALUES(?,?,?)");
            $fd->execute(array($email,$username,$feedback));
            if ($fd) {
    ...
    <footer class="bg-dark text-light pt-3 pb-4">
            <div class="container">
                <div id="footerlink" class="col-md-6 row mb-3 mt-1 ml-auto mr-auto">
                    ...
                    <a class="ml-auto mr-auto" href="#">Feedback</a>
                </div>
